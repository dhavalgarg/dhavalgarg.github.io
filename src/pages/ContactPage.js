...
const ContactPage = () => {
  return (
    <>
      <Head
        title={'Dhaval Garg | Contact'}
        description={`Please find my contact details below. Find me on any of the socials mentioned or send me a direct message via the form below. Alternatively, you can also send me an email and I'll get back to you.`}
      />
        ...
        <div className="page-center contact-page">
          ...
          <div className="section-title page-title">
            ...
            You can also drop an email at{' '}
              <a href="mailto:dhaval.garg@outlook.com" title="Email Me">
                dhaval.garg@outlook.com
              </a>
            </p>
          </div>
